...
class CustomTransform:
    def __init__(self, pad_method="zeros", max_size=(1352,1080), target_size=(224, 224), augment=False):
        """
        Args:
            pad_method (str): Padding method. Options are "zeros" (fill with 0s) or "reflect" (reflection padding).
            max_size (tuple): The shape (width, height) of the largest images in the datset that will be a reference for padding.
            target_size: Final image shape to be input of deep_learning models
